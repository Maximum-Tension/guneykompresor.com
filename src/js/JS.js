...
const	DOM =
{
	...
	LOAD_SVGS: async function()
	{
		...
		{
			var	SRC = SVG_NODES[INDEX].getAttribute("src");
...
const	AJAX =
{
	 ...
	 * @return {Promise<string|undefined>} Return response text or undefined if failed
	 */
	 ...
	 * @return {Promise<object|string>} Returns the response
	 */
	 ...
	 * @return {Promise<HTMLElement>} Returns response text or object
	 */
